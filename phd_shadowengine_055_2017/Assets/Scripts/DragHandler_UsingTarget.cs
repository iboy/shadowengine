...
public class DragHandler_UsingTarget : MonoBehaviour {
	...
	private TargetJoint2D springJoint;
	...
	public void dragStarted(Gesture gesture) {
		...
		if (!springJoint) {
			...
			this.springJoint = obj.AddComponent<TargetJoint2D>() as TargetJoint2D;
			...
			springJoint.autoConfigureTarget = true;
